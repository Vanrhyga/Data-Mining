...
#pool1 layer
hpool1=maxPool2x2(hconv1)   #output 14x14x32
...
#四维张量变为二维张量，第一位、维是样本数，第二维是输入特征，输入神经元的个数是7*7*64
...
#dropout
#防止过拟合
hfclDrop=tf.nn.dropout(hfc1,keepProb)
...
#softmax layer
yconv=tf.nn.softmax(tf.matmul(hfclDrop,Wfc2)+bfc2)
